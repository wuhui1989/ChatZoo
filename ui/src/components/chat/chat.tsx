            ...
            <div className={styles.banner}>
              ...
              <div className={styles.func}>
                <Tooltip title={<span className={styles.tooltipTitle}>切换布局</span>}>
                  <div onClick={() => { updateDoWrap(doWrap == styles.noWrap ? styles.wrap : styles.noWrap) }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M17.064 6.86705L14.2089 13.4861L7.75028 16.1836L10.5857 9.72427L17.064 6.86705Z" fill="white" />
